...
class NgxBootstrapProductTourService {
    /**
     * @param {?} router
     */
    constructor(router$$1) {
        ...
        this.events$ = mergeStatic(map$2.bind(this.stepShow$)(value => ({ name: 'stepShow', value })), map$2.bind(this.stepHide$)(value => ({ name: 'stepHide', value })), map$2.bind(this.initialize$)(value => ({ name: 'initialize', value })), map$2.bind(this.start$)(value => ({ name: 'start', value })), map$2.bind(this.end$)(value => ({ name: 'end', value })), map$2.bind(this.pause$)(value => ({ name: 'pause', value })), map$2.bind(this.resume$)(value => ({ name: 'resume', value })), map$2.bind(this.anchorRegister$)(value => ({ name: 'anchorRegister', value })), map$2.bind(this.anchorUnregister$)(value => ({ name: 'anchorUnregister', value })));
        this.steps = [];
        this.anchors = {};
 ...
 * @nocollapse
 */
NgxBootstrapProductTourService.ctorParameters = () => [
    { type: Router, },
];

class NgxBootstrapProductTourStepService {
}
 ...
 * @nocollapse
 */
NgxBootstrapProductTourStepService.ctorParameters = () => [];

class NgxBootstrapPopoverDirective extends PopoverDirective {
    constructor() {
        super(...arguments);
        this.triggers = '';
    }
 ...
 * @nocollapse
 */
NgxBootstrapPopoverDirective.ctorParameters = () => [];
class NgxBootstrapProductTourDirective {
    /**
     * @param {?} tourService
 ...
 * @nocollapse
 */
NgxBootstrapProductTourDirective.ctorParameters = () => [
...
class NgxBootstrapProductTourStepComponent {
    /**
     * @param {?} ngxBootstrapProductTourStepService
     * @param {?} tourService
     */
    constructor(ngxBootstrapProductTourStepService, tourService) {
 ...
 * @nocollapse
 */
NgxBootstrapProductTourStepComponent.ctorParameters = () => [
    { type: NgxBootstrapProductTourStepService, },
    { type: NgxBootstrapProductTourService, },
];
...
class NgxBootstrapProductTourModule {
    /**
     * @return {?}
     */
    static forRoot() {
 ...
 * @nocollapse
 */
NgxBootstrapProductTourModule.ctorParameters = () => [];
