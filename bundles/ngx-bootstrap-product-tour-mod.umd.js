...
var BsLocaleService = (function () {
    function BsLocaleService() {
        ...
        this._locale = new BehaviorSubject.BehaviorSubject(this._defaultLocale);
...
var MiniStore = (function (_super) {
    ...
    MiniStore.prototype.select = function (pathOrMapFn) {
        var mapped$ = map$1.map.call(this, pathOrMapFn);
...
var DraggableItemService = (function () {
    function DraggableItemService() {
        this.onCapture = new Subject.Subject();
    }
...
var NgxBootstrapProductTourService = /** @class */ (function () {
    ...
    function NgxBootstrapProductTourService(router$$1) {
        ...
        this.events$ = merge.mergeStatic(map$1.map.bind(this.stepShow$)(function (value) { return ({ name: 'stepShow', value: value }); }), map$1.map.bind(this.stepHide$)(function (value) { return ({ name: 'stepHide', value: value }); }), map$1.map.bind(this.initialize$)(function (value) { return ({ name: 'initialize', value: value }); }), map$1.map.bind(this.start$)(function (value) { return ({ name: 'start', value: value }); }), map$1.map.bind(this.end$)(function (value) { return ({ name: 'end', value: value }); }), map$1.map.bind(this.pause$)(function (value) { return ({ name: 'pause', value: value }); }), map$1.map.bind(this.resume$)(function (value) { return ({ name: 'resume', value: value }); }), map$1.map.bind(this.anchorRegister$)(function (value) { return ({ name: 'anchorRegister', value: value }); }), map$1.map.bind(this.anchorUnregister$)(function (value) { return ({ name: 'anchorUnregister', value: value }); }));
        this.steps = [];
        this.anchors = {};
...
NgxBootstrapProductTourDirective.ctorParameters = function () { return [
    ...
    { type: core.ElementRef, },
    { type: NgxBootstrapPopoverDirective, decorators: [{ type: core.Host },] },
]; };
NgxBootstrapProductTourDirective.propDecorators = {
    'tourAnchor': [{ type: core.Input },],
    'backdropClass': [{ type: core.HostBinding, args: ['class.tour-step-backdrop',] },],
};
...
exports.NgxBootstrapProductTourModule = NgxBootstrapProductTourModule;
exports.NgxBootstrapProductTourService = NgxBootstrapProductTourService;
exports.ɵd = NgxBootstrapProductTourStepComponent;
exports.ɵc = NgxBootstrapProductTourStepService;
exports.ɵa = NgxBootstrapPopoverDirective;
exports.ɵb = NgxBootstrapProductTourDirective;
